...
class TeachingAidObjectLessonScreen extends StatelessWidget {
  static const routeName = '/teaching_aid_objectlesson_screen';
  const TeachingAidObjectLessonScreen({Key? key}) : super(key: key);
